...
---
****
![_config.yml]({{ site.baseurl }}/images/2022-04-17--summary.png)
...
Bet: **Alexis Mac Allister to have two or more shots**  
Sky Bet odds in JK article: **5/6** | **1.83**
<p></p>
**Lost $100**
<p></p>
****
...
|Bet|**Gabriel to have at least one shot**|
{: .tablelines}
<p></p>
<style>
.tablelines table, .tablelines td, .tablelines th 
...
|Bet|**Brentford to win and Bryan Mbeumo to score**|
{: .tablelines}
<p></p>
<style>
.tablelines table, .tablelines td, .tablelines th 
...
|Bet|**Dan Burn to score a header**|
{: .tablelines}
<p></p>
<style>
.tablelines table, .tablelines td, .tablelines th 
...
|Bet|**Burnley to win six or more corners**|
{: .tablelines}
<p></p>
<style>
.tablelines table, .tablelines td, .tablelines th 
