...
<table style="border:1px solid black;">
  <tr style="background-color:white;border:1px solid black">
    <td style="border:1px solid black;"><b>Betting angle</b></td>
    <td colspan="2" ;  style="border:1px solid black;"><b>Dwight McNeil to score</b></td>
    </tr>
  <tr style="background-color:white;border:1px solid black">
  ...
  <tr style="background-color:mistyrose;border:1px solid black">
    ...
    <td colspan="2" ;  style="border:1px solid black;"><b>$100</b></td>
    </tr>
</table>
<p></p>
<table>
