...
Here are the "recommended bet" winners for this week (green box) and the correct "score predictions", which I've added in from the following gameweek's Jones Knows article.
...
So you end up with this little summary depending if you use the prices he quoted in his predictions article ("original") or if you use the prices they quoted when they listed the winners next week ("revised"):
